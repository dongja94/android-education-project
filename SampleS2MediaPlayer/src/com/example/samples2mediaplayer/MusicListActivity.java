...
public class MusicListActivity extends ActionBarActivity implements LoaderCallbacks<Cursor> {
	...
	String[] columns = {MediaStore.Audio.Media._ID, Audio.Media.DISPLAY_NAME};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new SimpleCursorAdapter(this, android.R.layout.simple_list_item_1, null, new String[] {Audio.Media.DISPLAY_NAME}, new int[]{android.R.id.text1}, 0);
